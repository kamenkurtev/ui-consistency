...
2. `docs/specs/2026-09-09-pattern-as-the-unit-of-knowledge.md` — what the tool writes down, and in what form.
...
**Everything else under `docs/` is a dated record and none of it is a reading list.** `docs/specs/` holds what was decided on a date, `docs/findings/` what a real run found, and `docs/design.md` the original statement of the problem and the two decisions — kept because it is quoted elsewhere, and overtaken in most of its particulars. Open one when the question is *what was decided then*, and never to find out what is true now.
