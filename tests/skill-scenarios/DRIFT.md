...
| D8 | planted | A pair below contrast | `components.css`: `.badge--muted`, used in `shipments.js` | #b0b0b0 on #ffffff is 2.17:1; the project states no threshold, so the named default applies. The theme's `--color-muted` (#52606d) is 6.46:1 |
