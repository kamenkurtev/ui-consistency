...
> Write a short plan to bring all four pages in line with `.ui-consistency/patterns/list-page.md`. Keep it brief — one line per page is plenty.

## Must happen

1. A calibration task for the checker comes before the pages.
2. Every page task names the pattern file.
