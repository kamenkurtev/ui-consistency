...
var STANDING = [
  ...
  "- A design for the page, a new page with no page near enough to follow, or a",
  "  wish to see a page before it is built: ui-consistency:design. It agrees the",
  "  shape in words, and draws it only when asked.",
  "- Reached from the phases when a step needs them: ui-consistency:values (theme,",
  "  spacing, type, elements), ui-consistency:conventions (counting what the pages",
  "  do) and ui-consistency:decisions (the order, and what waits on a person).",
