...
unreadable together. Record the pairings the family uses — text and what carries
meaning without text, in every scheme — against the project's threshold or a
named default. How, with the ratio arithmetic, in [contrast.md](contrast.md).
